...
abstract class AppLocalizations {
  ...
  /// No description provided for @categoryPassword.
  ///
  /// In en, this message translates to:
  /// **'Category Password'**
  ...
  /// No description provided for @pleaseAddEvent.
  ///
  /// In en, this message translates to:
  /// **'Please add an event first'**
  String get pleaseAddEvent;

  /// No description provided for @pleaseSelectEvent.
  ///
  /// In en, this message translates to:
  /// **'Please select an event to count'**
  ...
  /// No description provided for @increaseCount.
  ///
  /// In en, this message translates to:
  /// **'Increase Count'**
  String get increaseCount;

  /// No description provided for @switchEvent.
  ///
  /// In en, this message translates to:
  /// **'Switch Event'**
  String get switchEvent;
  ...
  /// No description provided for @defaultSetSuccess.
  ///
  /// In en, this message translates to:
  /// **'{eventName} has been set as default'**
  String defaultSetSuccess(String eventName);

  /// No description provided for @defaultSetFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to set default event: {error}'**
